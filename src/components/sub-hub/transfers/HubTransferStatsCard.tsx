  ...
  return [
    {
      ...
      subtitle: "Dispatched to hub today",
    },
    {
      id: "pending-vehicle",
      label: "Pending Allocation",
      value: String(stats.pendingVehicleAssignment).padStart(2, "0"),
      subtitle: "Allocated, awaiting dispatch",
    ...
    },
    {
      ...
      subtitle: "Warehouse → hub transfers",
      variant: "default",
    },
    {
      id: "delivered-today",
      ...
      subtitle: "Received at hub today",
      variant: "success",
    },
    {
      id: "delayed",
      ...
      subtitle: "Past expected arrival window",
